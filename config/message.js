...
module.exports = {
  MESSAGE: {
    ...
    UPGRADE:{
      message: "Thank you for applying to upgrade. We will get back to you soon!"
    },

    // Bad Request or invalid data
    BAD_REQUEST: {
      message: "The request cannot be fulfilled due to bad syntax. Please try again",
    },
    MISSING_FIELDS: {
    ...
    // Report Error
    ERROR_FETCH_DATA: {
      message: "Error while fetching data from database. Contact customer service!",
    },
    CREATE_FEEDBACK: {
